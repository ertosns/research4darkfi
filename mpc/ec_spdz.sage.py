...
# This file was *autogenerated* from the file ec_spdz.sage
...
party1_val = random.randint(_sage_const_0 ,p)
party1_random = random.randint(_sage_const_0 ,p)
beta1 = AuthenticatedShare(party1_random, source, _sage_const_0 )
beta2 = AuthenticatedShare(party1_val - party1_random, source, _sage_const_0 )


a1b1 = ScalingECAuthenticatedShares(alpha1, beta1, source.triplet(_sage_const_0 ), _sage_const_0 )
a2b2 = ScalingECAuthenticatedShares(alpha2, beta2, source.triplet(_sage_const_1 ), _sage_const_1 )
