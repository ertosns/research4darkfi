...
# This file was *autogenerated* from the file inner_product_proof.sage
...
H = [CurvePoint.generator() for i in range(_sage_const_0 ,n)]
G = [CurvePoint.generator() for i in range(_sage_const_0 ,n)]
